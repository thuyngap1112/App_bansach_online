...
public class TheloaiAdapter extends BaseAdapter {
    ...
    @Override
    public int getCount() {
        return arraylisttheloai.size(); //đổ các dữ liệu thể loại ra
    }

    @Override
    public Object getItem(int i) {
        return arraylisttheloai.get(i); //lấy ra từ thuộc tính có tr mảng
    }
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ...
        //khi run project lên thì vieww = null
        if (view == null){
...
//            viewHolder.txttentheloai = (TextView) view.findViewById(R.id.textviewtheloai;
        ...
        }else { //khi run lần thứ 2 chỉ cần get lại
